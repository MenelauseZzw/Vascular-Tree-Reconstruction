#ifndef CurvatureCostFunction_cuh
#define CurvatureCostFunction_cuh
...
__host__ __device__ ResultType CurvatureCostFunctionAt(const Arg1ValueType(&tildePi)[NumDimensions], const Arg2ValueType(&si)[NumDimensions], const Arg3ValueType(&ti)[NumDimensions], const Arg4ValueType(&tildePj)[NumDimensions], const Arg5ValueType(&sj)[NumDimensions], const Arg6ValueType(&tj)[NumDimensions])
{
...
#endif//CurvatureCostFunction_cuh