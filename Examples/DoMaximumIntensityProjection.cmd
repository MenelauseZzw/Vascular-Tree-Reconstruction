...
--polyDataFiles "PolyDataFile(tree_structure.vtp,1,85,255,127)" "PolyDataFile(ObjectnessMeasureVolumeTangents.vtp,2,255,255,127)" "PolyDataFile(NonMaximumSuppressionVolumeTangents.vtp,3,255,170,255)" "PolyDataFile(1.95/NonMaximumSuppressionCurvVolumeTangents.vtp,4,85,170,255)" "PolyDataFile(1.00/NonMaximumSuppressionCurvVolumeTangents.vtp,5,255,85,127)"